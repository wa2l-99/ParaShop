...
class __TwigTemplate_aaa14992d4b69299fbb4ffb0632b9eac25cab14bc774ef05b41bf00a03ef7b6b extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    {
        return array (  121 => 19,  116 => 17,  110 => 14,  106 => 13,  102 => 12,  94 => 9,  89 => 6,  79 => 5,  59 => 3,  36 => 1,);
    }
...
{% block title %}{{ product.name }} - La Boutique Tunisienne{% endblock %}
...
{% block content %}
    ...
    <div class=\"row\">
        ...
        <div class=\"col-md-7 my-auto\">
            ...
            <span class=\"product-page-price\">{{ (product.price / 100)|number_format(2, ',', '.') }} TND</span>
            <hr>
            <p>
                {{ product.description }}
            </p>
...
{% endblock %}
", "product/show.html.twig", "/home/wael/e-commerce/templates/product/show.html.twig");
    }
}
